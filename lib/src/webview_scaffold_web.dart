...
import 'package:flutter_webview_plugin/flutter_webview_plugin_web.dart';
import 'package:flutter_webview_plugin/src/javascript_channel.dart';

class WebviewScaffoldWeb extends StatefulWidget {
  const WebviewScaffoldWeb({
    Key key,
    this.appBar,
    @required this.url,
    this.headers,
  ...
  @override
  _WebviewScaffoldWebState createState() => _WebviewScaffoldWebState();
}

class _WebviewScaffoldWebState extends State<WebviewScaffoldWeb> {
  final webviewReference = FlutterWebViewPluginWeb();
  Rect _rect;
  Timer _resizeTimer;
